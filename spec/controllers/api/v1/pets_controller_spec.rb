  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested api_v1" do
        pet = Api::V1::Pet.create! valid_attributes
        put :update, {:id => pet.to_param, :api_v1 => new_attributes}, valid_session
        pet.reload
      ...
      it "redirects to the api_v1" do
        pet = Api::V1::Pet.create! valid_attributes
        put :update, {:id => pet.to_param, :api_v1 => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        pet = Api::V1::Pet.create! valid_attributes
        put :update, {:id => pet.to_param, :api_v1 => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
